...
const CAROUSEL = [
  {
    image: "./assets/images/carousel/coffee-slider-1.png",
    alt: "S’mores Frappuccino",
    name: "S’mores Frappuccino",
    info: "This new drink takes an espresso and mixes it with brown sugar and cinnamon before being topped with oat milk.",
    price: "$5.50",
  },
  {
    image: "./assets/images/carousel/coffee-slider-2.png",
    alt: "Caramel Macchiato",
    name: "Caramel Macchiato",
    info: "Fragrant and unique classic espresso with rich caramel-peanut syrup, with cream under whipped thick foam.",
    price: "$5.00",
  },
  {
    image: "./assets/images/carousel/coffee-slider-3.png",
    alt: "Ice coffee",
    name: "Ice coffee",
    info: "A popular summer drink that tones and invigorates. Prepared from coffee, milk and ice.",
    price: "$4.50",
  },
];
